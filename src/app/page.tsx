  ...
  return (
    <main className="p-6">
      <header className="mb-8 pt-4 flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-slate-800">Ringkasan Kas</h1>
          <p className="text-sm text-slate-500">Pantau seluruh keuangan Anda dengan My Family Menjadi Bahagia</p>
        </div>
